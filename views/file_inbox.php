        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Shared Files</h3>
                   ...
                   foreach ($dataset as $row)
                   {
                    ...
                    if($row['Format'] == 0)
                       ...
                       echo '<tr><td style="color:grey;">'.$row['File message'].'</td>
                                 ...
                                 <td><a href="'.base_url("/ViewerJS/#../uploads/documents/".$z."").'" target="_blank">
                                 <img src="'.base_url("ext/dist/img/view.png").'" /></a>
                                 </td>
                                 
                       </tr>';//<td><a href="'.base_url("/ViewerJS/#../uploads/documents/".$z."").'" target="_blank">
                   }
