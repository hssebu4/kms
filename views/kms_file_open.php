...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li ><a href="<?php echo base_url().'kms/';?> "><i class="fa fa-align-justify"></i><?php echo $Menu_item_04_03 ?></a></li><!--News option-->
  ...
  <div class="content-wrapper">
    <br><br>
     ...
     <h5>
        NHOP
        <small><?php echo $this->session->userdata('kms_emp_department');?> Department</small>
      </h5>
      <ol class="breadcrumb">
        <li ><a href="<?php echo base_url();?>kms"><i class="fa fa-bars"></i> Home</a></li>
    ...
    <section class="content"> 
       ...
       <div class="col-md-12">
         <div class="box box-primary">
           ...
           <form action="<?php echo base_url();?>kms/File_UploadPersonal_Technology" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-dialog">
                        ...
                        <h3 class="box-title pull-right" style="">KMS | File Sharing</h3>
                            ...
                            <div class="modal-body">
                                  ...
                                  <form action="<?php echo base_url();?>kms/Personal_file_share" class="form-horizontal" autocomplete="off" method="POST" enctype="multipart/form-data" name="kms_form_share_file" onsubmit="return validateform_file_share_form()" >
                                      <div class="box-body">
