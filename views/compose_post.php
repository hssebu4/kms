...
<div class="wrapper">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php $session_name = $this->session->userdata('kms_emp_data_secondname'); echo $session_name;  ?> - Web Developer
  ...
  <section class="content-header">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="<?php echo base_url();?>Administration/News" class="btn btn-primary btn-block margin-bottom" style="background-color:#2e3192;color:white;">Back to Post List</a>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="<?php echo base_url();?>Administration/News"><i class="fa fa-inbox"></i> Posts
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h5 class="box-title">Compose New Post</h5>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <div class="form-group">
                    <textarea id="compose-textarea" class="form-control" style="height: 220px">
              ...
              <div class="pull-right">
                ...
                <button type="submit" class="btn btn-primary" style="background-color:#2e3192;color:white;"><i class="fa fa-envelope-o"></i> Send</button>
              </div>
