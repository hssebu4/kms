    ...
    <section class="content"> 
       ...
       <div class="col-md-12">
         <div class="box box-primary">
           ...
           <form action="<?php echo base_url();?>forum/File_UploadPersonal_Forum" method="POST" enctype="multipart/form-data">
           <div class="pull-left"><input type="file" name="kms_tech_uploadfile" id="kms_tech_uploadfile" /></div>
           <div class="pull-right"><button class="btn btn-primary btn-sm" type="submit">Upload File<i class="fa fa-upload" aria-hidden="true"></i></button></div>
           </form>
           </div> 
                    ...
                    print("<table id=\"example1\" class=\"table table-bordered  table-hover \">
                        ...
                        if(isset($Kms_userupload_results)){ 
                             ...
                             // echo "<td>".$row['kms_upload_date']."</td>";
                              ...
                              <a class=\"Upload_save_modal\" style=\"color:green;\" data-id=".$row['kms_upload_id'].">Send</a>&nbsp; &nbsp;
                             </td>";
                              echo "</tr>";// <a href=\"\" style=\"color:red;\"><i class=\"fa fa-trash\"></i></a>
                              }
  ...
  <!-- /.content-wrapper -->
                  ...
                  <div id="Upload_modal_form" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <h3 class="box-title pull-right">KMS | File Sharing</h3>
                        </div>
                            <div class="modal-body">
                                  ...
                                  <form action="<?php echo base_url();?>Forum/Personal_file_share" class="form-horizontal" autocomplete="off" method="POST" enctype="multipart/form-data" name="kms_form_share_file" onsubmit="return validateform_file_share_form()" >
                                      ...
                                      <option value="8"><?php echo $Menu_item_00_01_08; ?></option>
                                        ...
                                        <div class="form-group">
                                          <label for="kms_input_fchat_topic" class="col-sm-3 control-label">Projects:</label>

                                          <div class="col-sm-9">
                                         
                                          <select class="selectpicker_live_projects" data-size="6" name="kms_input_file_recipient_project" id="kms_input_file_recipient_project" multiple data-live-search="true">
                                            <?php 
                                           
                                      
                                            $Project_list = $this->session->userdata('kms_active_projects');
                                            if(isset( $Project_list) &&  $Project_list != "")
                                            {
                                            foreach ( $Project_list as $row_emp)
                                            {
                                                echo "<option value=".$row_emp['kms_project_id'].">".$row_emp['kms_project_detail']."</option>";
                                            }
                                            }else
                                             {
                                                echo "<option value=\"\"> No data</option>";
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-9">
                                            <textarea class="form-control" rows="3" placeholder="Enter sharing message..." id="kms_input_file_share_message" name="kms_input_file_share_message" placeholder="Enter your sharing message" required></textarea>
                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="hidden" name="Kms_input_hidden_project_id" id="Kms_input_hidden_project_id">
...
$(document).ready( function ()
 {
  $('#example1').DataTable({
    ...
    //$("#example1").on("click", ".test .toggleTest", function ...);
    ...
    $('.selectpicker_live_projects').selectpicker();
...
;
//Enable the modal work in datatables
$("#example1").delegate("tbody tr", "click", function (event) {
  $("a[class='Upload_save_modal']").click(function () {
          //In this we pass data to the modal from the <a> tag as data-id and set 
          var Upload_file_id = $(this).data('id');
          $(".modal-body #Kms_input_hidden_file_id").val(Upload_file_id);
